...
export const geodeBloomModule: ModuleDefinition = {
  ...
  icon: GeodeBloomIcon,
  meta: {
    name: 'Geode Bloom', shortName: 'Geode', color, tint: '#f8e8ff', energy: 40, rarity: 'epic',
  ...
  onCast: ({ effects: engine, position, rotation }) => engine.spawn('module:geode-bloom:muzzle', { position, rotation, color }),
  onHit: ({ effects: engine, position, rotation, projectile }) => {
    if (projectile?.splash === 0) return;
    engine.spawnMany(
      ['module:geode-bloom:blast-outer', 'module:geode-bloom:blast-inner', 'module:geode-bloom:shards', 'module:geode-bloom:debris'],
