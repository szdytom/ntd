    ...
    shockwave({ id: 'module:toxic-cloud:spawn', lifetime: 0.52, radius: 82, stroke: 3, sides: 8, layer: 'ground' }),
    {
        ...
        render: (frame, painter) => {
            for (let index = 0; index < 13; index += 1) {
                ...
                painter.circle(frame.x + Math.cos(angle) * travel, frame.y + Math.sin(angle) * travel, radius, index % 3 === 0 ? '#d8f5a2' : frame.color, frame.fout * 0.34);
            }
        },
    },
    {
...
export const toxicCloudModule: ModulePresentation = {
    ...
    icon: ToxicCloudIcon,
    meta: {
        color, displayColor: '#42a853', tint: '#ebfbee'
    },
    effects,
