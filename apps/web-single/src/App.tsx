...
export interface SinglePlayerAppProps { homeActions?: ReactNode }
  ...
  return <>
    ...
    {defenseArchiveOpen
      ...
      : engine
        ...
        />
        : <LevelSelect homeActions={homeActions} onStart={start} onOpenArchive={() => setArchiveType(DEFAULT_SIGNAL_ID)} onOpenDefenseArchive={() => setDefenseArchiveOpen(true)} onOpenThought={() => openThought()} />}
