...
const effects: readonly EffectDefinition[] = [
    {
        ...
        render: (frame, painter) => {
            ...
            for (const side of [-1, 1]) {
                ...
                painter.lineAngle(x, y, perpendicular, 28 + frame.fout * 16, 3.4 * frame.fout, side > 0 ? '#ffffff' : frame.color, frame.fout);
            }
    ...
    },
    {
        ...
        render: (frame, painter) => {
            ...
            for (let index = 0; index < 4; index += 1) {
                ...
                painter.lineAngle(x, y, angle + Math.PI / 2, 15 + frame.slope * 17, 3.2 * frame.fout + 0.4, index % 2 === 0 ? frame.color : '#ffffff', frame.fout);
            }
...
export const prismSlugModule: ModulePresentation = {
    ...
    icon: PrismSlugIcon,
    meta: {
        color, displayColor: '#2864c7', tint: '#e7f1ff'
    },
    effects,
