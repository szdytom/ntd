      ...
      >
        {visibleSlotsFor(target.towerIndex).map(({ module, index }) => {
          ...
          const previousModule = replacement
            ...
            : null;
          const PreviousIcon = previousModule ? modulePresentationRegistry.require(previousModule.id).icon : undefined;
          ...
          >
            {previousModule && PreviousIcon ? <div
              ...
              style={{ '--chip-color': moduleUiColor(previousModule), '--chip-tint': moduleUiTint(previousModule) } as CSSProperties}
              aria-hidden="true"
            >
            ...
            <div
              ...
              style={{ '--chip-color': moduleUiColor(module), '--chip-tint': moduleUiTint(module) } as CSSProperties}
            >
